...
graph TD
    ...
    C --> D[Ch 5: Solar Suicide<br/>Imported Panels → Sovereign Silicon Command]
    
    D --> E[Core Verification Layer<br/>chapter5_core.py]
    E --> F[Learning Curve Trap Simulator]
    F --> G[Dependency Manifold Explorer]
    G --> H[ASP/ARP Framework & Sovereignty Metric Projector]
    H --> I[Industrial Jobs Clawback Analyzer]
    I --> J[2030 Sovereign Brain Horizon]
